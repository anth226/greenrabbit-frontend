<script>
			...
			actions: [
				{
					...
					data: {
						...
						quantity: amount.toFixed(4) + ' SHELL',
	...
	$: amount = get_diff_hours_left(end, $now) * 2 * (weight / 10000);
</script>
	...
	<div class="content">
		...
		<div class="buttons">
			<CtaButton
				...
				margin="0 0 16px 0"
			/>
			<CtaButton onClick={onClose} text="CANCEL" outlined width="280px" fontSize="16px" />
		</div>
	</div>
</div>
